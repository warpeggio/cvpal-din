...
*/
//WTODO: This file needs the --gnu99 option to compile, but it will compile.
///usr/local/CrossPack-AVR/bin/avr-gcc -c -std=gnu99 -mmcu=attiny84 -I. -g -Os -w -Wall \
	-DF_CPU=20000000 -D__PROG_TYPES_COMPAT__ -fdata-sections -ffunction-sections \
	-fshort-enums -fno-move-loop-invariants   -DATTINY84 -DSERIAL_RX_0 \
	-mcall-prologues -fno-exceptions SoftwareSerial/SoftwareSerial.c -o build/cvpal/SoftwareSerial.o
